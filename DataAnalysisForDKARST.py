...
Initial_Conditions1 = np.load('outputs\InitialConditions-1turbulent2021-06-22.npy')
Initial_Conditions2 = np.load('outputs\InitialConditions-2.5turbulent2021-06-23.npy')
Initial_Conditions5 = np.load('outputs\InitialConditions-5turbulent2021-06-23.npy')
Initial_Conditions10 = np.load('outputs\InitialConditions-10turbulent2021-06-23.npy')
# =============================================================================
...
Impact_Data1 = np.load('outputs\Impacts-1turbulent2021-06-22.npy')
Impact_Data2 = np.load('outputs\Impacts-2.5turbulent2021-06-23.npy')
Impact_Data5 = np.load('outputs\Impacts-5turbulent2021-06-23.npy')
Impact_Data10 = np.load('outputs\Impacts-10turbulent2021-06-23.npy')
# =============================================================================
...
Deposition_Data1 = np.load('outputs\TravelDistances-1turbulent2021-06-22.npy')
Deposition_Data2 = np.load('outputs\TravelDistances-2.5turbulent2021-06-23.npy')
Deposition_Data5 = np.load('outputs\TravelDistances-5turbulent2021-06-23.npy')
Deposition_Data10 = np.load('outputs\TravelDistances-10turbulent2021-06-23.npy')
# =============================================================================
