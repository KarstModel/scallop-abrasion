...
Diam1 = genfromtxt('./outputs/diam1turbulent2021-03-12.csv', delimiter=',')
Diam2_5 = genfromtxt('./outputs/diam2.5turbulent2021-03-11.csv', delimiter=',')
Diam5 = genfromtxt('./outputs/diam5turbulent2021-03-12.csv', delimiter=',')
Diam10 = genfromtxt('./outputs/diam10turbulent2021-03-12.csv', delimiter=',')
EAI1 = genfromtxt('./outputs/ErosionAtImpact1turbulent2021-03-12.csv', delimiter=',')
EAI2_5 = genfromtxt('./outputs/ErosionAtImpact2.5turbulent2021-03-11.csv', delimiter=',')
EAI5 = genfromtxt('./outputs/ErosionAtImpact5turbulent2021-03-12.csv', delimiter=',')
EAI10 = genfromtxt('./outputs/ErosionAtImpact10turbulent2021-03-12.csv', delimiter=',')
XAtImpact1 = genfromtxt('./outputs/XAtImpact1turbulent2021-03-12.csv', delimiter=',')
XAtImpact2_5 = genfromtxt('./outputs/XAtImpact2.5turbulent2021-03-11.csv', delimiter=',')
XAtImpact5 = genfromtxt('./outputs/XAtImpact5turbulent2021-03-12.csv', delimiter=',')
XAtImpact10 = genfromtxt('./outputs/XAtImpact10turbulent2021-03-12.csv', delimiter=',')
NEA1_old = genfromtxt('./outputs/NormErosionAvg1turbulent2021-03-12.csv', delimiter=',')
NEA2_5_old = genfromtxt('./outputs/NormErosionAvg2.5turbulent2021-03-11.csv', delimiter=',')
NEA5_old = genfromtxt('./outputs/NormErosionAvg5turbulent2021-03-12.csv', delimiter=',')
NEA10_old = genfromtxt('./outputs/NormErosionAvg10turbulent2021-03-12.csv', delimiter=',')
KEAI1 = genfromtxt('./outputs/EnergyAtImpact1turbulent2021-03-12.csv', delimiter=',')
KEAI2_5 = genfromtxt('./outputs/EnergyAtImpact2.5turbulent2021-03-11.csv', delimiter=',')
KEAI5 = genfromtxt('./outputs/EnergyAtImpact5turbulent2021-03-12.csv', delimiter=',')
KEAI10 = genfromtxt('./outputs/EnergyAtImpact10turbulent2021-03-12.csv', delimiter=',')
